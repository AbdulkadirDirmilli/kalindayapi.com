...
export default function Footer() {
  ...
  // These pages use Turkish folder names, so we don't use getLocalizedRoute
  const popularSearches = {
    tr: [
      { name: "Ortaca Satılık Daire", href: `/${locale}/ortaca-satilik-daire` },
      { name: "Ortaca Kiralık Daire", href: `/${locale}/ortaca-kiralik-daire` },
      { name: "Dalaman Satılık Ev", href: `/${locale}/dalaman-satilik-ev` },
      { name: "Dalyan Satılık Villa", href: `/${locale}/dalyan-satilik-villa` },
      { name: "Ortaca Öğrenci Kiralık", href: `/${locale}/ortaca-ogrenci-kiralik` },
      { name: "Ortaca Emlak Ofisi", href: `/${locale}/ortaca-emlak-ofisi` },
    ],
    en: [
      { name: "Ortaca Apartments for Sale", href: `/${locale}/ortaca-satilik-daire` },
      { name: "Ortaca Apartments for Rent", href: `/${locale}/ortaca-kiralik-daire` },
      { name: "Dalaman Houses for Sale", href: `/${locale}/dalaman-satilik-ev` },
      { name: "Dalyan Villas for Sale", href: `/${locale}/dalyan-satilik-villa` },
      { name: "Ortaca Student Rentals", href: `/${locale}/ortaca-ogrenci-kiralik` },
      { name: "Ortaca Real Estate Office", href: `/${locale}/ortaca-emlak-ofisi` },
    ],
    ar: [
      { name: "شقق للبيع في أورتاجا", href: `/${locale}/ortaca-satilik-daire` },
      { name: "شقق للإيجار في أورتاجا", href: `/${locale}/ortaca-kiralik-daire` },
      { name: "منازل للبيع في دالامان", href: `/${locale}/dalaman-satilik-ev` },
      { name: "فلل للبيع في دالان", href: `/${locale}/dalyan-satilik-villa` },
      { name: "إيجار طلاب في أورتاجا", href: `/${locale}/ortaca-ogrenci-kiralik` },
      { name: "مكتب عقارات أورتاجا", href: `/${locale}/ortaca-emlak-ofisi` },
    ],
    de: [
      { name: "Ortaca Wohnungen kaufen", href: `/${locale}/ortaca-satilik-daire` },
      { name: "Ortaca Wohnungen mieten", href: `/${locale}/ortaca-kiralik-daire` },
      { name: "Dalaman Häuser kaufen", href: `/${locale}/dalaman-satilik-ev` },
      { name: "Dalyan Villen kaufen", href: `/${locale}/dalyan-satilik-villa` },
      { name: "Ortaca Studentenwohnungen", href: `/${locale}/ortaca-ogrenci-kiralik` },
      { name: "Ortaca Immobilienbüro", href: `/${locale}/ortaca-emlak-ofisi` },
    ],
    ru: [
      { name: "Квартиры на продажу Ортаджа", href: `/${locale}/ortaca-satilik-daire` },
      { name: "Квартиры в аренду Ортаджа", href: `/${locale}/ortaca-kiralik-daire` },
      { name: "Дома на продажу Даламан", href: `/${locale}/dalaman-satilik-ev` },
      { name: "Виллы на продажу Дальян", href: `/${locale}/dalyan-satilik-villa` },
      { name: "Студенческое жильё Ортаджа", href: `/${locale}/ortaca-ogrenci-kiralik` },
      { name: "Агентство недвижимости Ортаджа", href: `/${locale}/ortaca-emlak-ofisi` },
    ],
  };
